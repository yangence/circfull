import pandas as pd,sys,sys,os,pysam
...
def fusion2CombinFL(options):
    ...
    consFL_1=pd.read_csv(outPrefix+'constructFL_Fusion2_adj_1.txt',sep='\t')
    consFL_2=pd.read_csv(outPrefix+'constructFL_Fusion2_adj_2.txt',sep='\t')
    ...
    BSdf=pd.read_csv(outPrefix+'BS_Fusion2_adj.txt',sep='\t')
    explainF=pd.read_csv(outPrefix+"explainFL_Fusion2.txt",sep='\t')
    ...
    consFL_out.to_csv(outPrefix+'result_fusion2.txt',sep='\t')
